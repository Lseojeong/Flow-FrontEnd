...
export default function DictionaryPage() {
  ...
  const handleRegisterCategory = ({ name, description }: { name: string; description: string }) => {
    // TODO: 실제 카테고리 등록 로직 구현
    console.log('카테고리 등록:', { name, description });
  };
