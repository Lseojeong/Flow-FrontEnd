    ...
    <PageWrapper>
      ...
      <Content>
        ...
        <FilterBar>
          ...
          <DepartmentSelect
            options={categories.flatMap(cat => cat.departments)}
        ...
        <TableLayout>
          <TableHeader
            columns={[
              ...
              { label: 'FAQ 제목', width: '300px', align: 'left' },
              { label: '상태', align: 'left' },
              { label: '문서 수', align: 'center' },
              { label: '포함 부서', width: '300px', align: 'left' },
          ...
          {categories.length === 0 ? (
            <EmptyRow>
              <EmptyCell colSpan={7}>
                <EmptyMessage>FAQ를 등록해주세요.</EmptyMessage>
              </EmptyCell>
            </EmptyRow>
          ) : (
            categories.map(category => {
              ...
              return (
                <TableRow key={category.id}>
                  ...
                  <TableCell align="center">{category.documentCount}</TableCell>
                  <TableCell align="left">
